    ...
    >
      <div className="max-h-[88%] overflow-y-auto rounded-t-[28px] border-t border-white bg-white p-5 pb-6 shadow-[0_-24px_50px_-20px_rgba(23,26,31,0.35)]">
        ...
        <div className="flex items-start justify-between gap-3">
          <h3
            className="text-[21px] font-semibold leading-snug text-ink2"
          ...
          <button
            onClick={onClose}
            className="shrink-0 rounded-full bg-canvas px-3 py-1.5 text-[13px] font-semibold text-slate"
          >
            Close
          </button>
        </div>
