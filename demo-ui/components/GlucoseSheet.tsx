  ...
  async function submit() {
    ...
    try {
      const res = await fetch("/api/state", {
        ...
        body: JSON.stringify({ action: "logGlucose", value: Number(value), context }),
      });
  ...
  return (
    ...
    >
      <div className="rounded-t-[28px] border-t border-white bg-white p-5 pb-6 shadow-[0_-24px_50px_-20px_rgba(23,26,31,0.35)]">
        ...
        <div className="mt-4 text-[11.5px] font-semibold uppercase tracking-wide text-slate">When</div>
