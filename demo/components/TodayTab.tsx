...
export default function TodayTab({
  ...
  return (
    <div
      className="px-5 pb-8 pt-4 font-[family-name:var(--font-body)] text-ink2"
                  ...
                  <div className="flex items-center gap-3.5">
                    ...
                    >
                      ...
                      <span className="min-w-0 flex-1">
                        <span className={`block text-[15.5px] font-semibold ${isDone ? "text-slate line-through" : "text-ink2"}`}>
                          {t.title}
                        </span>
...
// Soft mint completion ring for the streak card.
