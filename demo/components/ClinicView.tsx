      ...
      <header className="flex items-end justify-between border-b border-line pb-4">
        <div>
          <div className="flex items-center gap-2.5">
            <Link
              href="/"
              className="font-serif text-lg font-medium text-ink hover:text-care"
            >
              Cadence
            </Link>
            <span className="rounded-full bg-care-wash px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-care-strong">
              Clinician
            </span>
          </div>
        ...
        <div className="flex gap-2">
          {!started ? (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-care px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-care-strong focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-care"
            >
          ...
          <button
            onClick={resetDemo}
            className="rounded-xl border border-line bg-white px-4 py-2.5 text-sm font-medium text-muted hover:text-ink"
          >
            Reset demo
          </button>
        </div>
